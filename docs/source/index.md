...
Issues <https://github.com/Dtar380/VideoService/issues>
Security <https://github.com/Dtar380/VideoService/security/policy>
Source <https://github.com/Dtar380/VideoService>
```
...
[GettingStarted](./GettingStarted/installation.md)
  Learn to install and set-up **VideoService**.

[Docs](./Documentation/database.md)
  Documentation of **VideoService**.
